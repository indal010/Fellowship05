...
namespace EmployeeManagement
{
    public class Salary
    {
        ...
        {
            return new SqlConnection("Data Source=.;Initial Catalog=payroll_service;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
